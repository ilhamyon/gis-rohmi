...
export const deauthUser = () => {
	...
	try {
        clearToken();
        localStorage.removeItem('relawanRohmi_token');
        localStorage.removeItem('relawanRohmi_user');
        localStorage.removeItem('typeUser');
        localStorage.removeItem('relawanRohmi_id');
        localStorage.removeItem('relawanRohmi_userData');
