...
const createSanityUser = async (relawanRohmi_userData) => {
    ...
    const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
      ...
      body: JSON.stringify({
        mutations: [
          {
            create: {
              _type: 'user-relawan-rohmi', // Ganti dengan jenis dokumen pengguna di Sanity Anda
              name: relawanRohmi_userData.name,
              email: relawanRohmi_userData.email,
              password: relawanRohmi_userData.password,
              type: relawanRohmi_userData.type,
            },
          },
        ],
      }),
